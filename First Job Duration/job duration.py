...
plt_2012 = start_work_2012['First Job Duration'].hist(bins=10)
plt_2012.set_xlabel("Duration (Months)")
plt_2012.set_ylabel("Count")
plt_2012.set_title('2012 Job Duration')
plt.show()

plt_2013 = start_work_2013['First Job Duration'].hist(bins=8)
plt_2013.set_xlabel("Duration (Months)")
plt_2013.set_ylabel("Count")
plt_2013.set_title('2013 Job Duration')
plt.show()

plt_2014 = start_work_2014['First Job Duration'].hist(bins=10)
plt_2014.set_xlabel("Duration (Months)")
plt_2014.set_ylabel("Count")
plt_2014.set_title('2014 Job Duration')
plt.show()

plt_2015 = start_work_2015['First Job Duration'].hist(bins=8)
plt_2015.set_xlabel("Duration (Months)")
plt_2015.set_ylabel("Count")
plt_2015.set_title('2015 Job Duration')
plt.show()

plt_2016 = start_work_2016['First Job Duration'].hist(bins=8)
plt_2016.set_xlabel("Duration (Months)")
plt_2016.set_ylabel("Count")
plt_2016.set_title('2016 Job Duration')
plt.show()

plt_2017 = start_work_2017['First Job Duration'].hist(bins=5)
plt_2017.set_xlabel("Duration (Months)")
plt_2017.set_ylabel("Count")
plt_2017.set_title('2017 Job Duration')
plt.show()